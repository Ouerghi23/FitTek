...
import com.example.tekfit.model.UserPosts;
...
public class PostActivity extends AppCompatActivity
{
    ...
    private void OpenViewImageDialog(final String tempPostFirstImage, final String tempPostSecondImage, String tempPostThirdImage) {
        ...
        ImageView image1 = viewImagesDialog.findViewById(R.id.viewphoto_first_image);
        image1.setVisibility(View.VISIBLE);
        Picasso.get().load(tempPostFirstImage).into(image1, new com.squareup.picasso.Callback() {
            @Override
        ...
        if (!TextUtils.isEmpty(tempPostSecondImage)) {
            ...
            ImageView image2 = viewImagesDialog.findViewById(R.id.viewphoto_second_image);
            image2.setVisibility(View.VISIBLE);
            Picasso.get().load(tempPostSecondImage).into(image2, new com.squareup.picasso.Callback() {
                @Override
                public void onSuccess() {
        ...
        if (!TextUtils.isEmpty(tempPostThirdImage)) {
            ...
            ImageView image3 = viewImagesDialog.findViewById(R.id.viewphoto_third_image);
            image3.setVisibility(View.VISIBLE);
            Picasso.get().load(tempPostThirdImage).into(image3, new com.squareup.picasso.Callback() {
                @Override
                public void onSuccess() {
        ...
        ImageView closebtn = viewImagesDialog.findViewById(R.id.viewphoto_close_button);
